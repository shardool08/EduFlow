  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Teacher Settings</Text>
        <Text style={styles.hint}>Coming soon: your name, school, class details, language preference, and English comfort level.</Text>
      </View>
    </SafeAreaView>
  );
}
